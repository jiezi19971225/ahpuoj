...
START TRANSACTION;
USE `oj`;
INSERT INTO `oj`.`role` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (1, 'user', '用户', 'NOW()', 'NOW()');
INSERT INTO `oj`.`role` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (2, 'admin', '管理员', 'NOW()', 'NOW()');
INSERT INTO `oj`.`role` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (3, 'secondaryadmin', '次级管理员', 'NOW()', 'NOW()');
